...
export const siteContent: SiteContent = {
  ...
  faq: {
    ...
    description: 'Everything you need to know about working with me on your content creation projects.',
    items: [
      {
        id: 'timeline',
        question: 'What is the typical timeline for a project?',
        answer: 'Project timelines vary based on scope and complexity. Essential packages typically take 1-2 weeks from shoot to delivery, Professional packages take 2-3 weeks, and Enterprise campaigns can take 4-6 weeks. Rush delivery is available for urgent projects with additional fees.',
      },
      {
        id: 'locations',
        question: 'Do you travel for shoots?',
        answer: 'Yes, I travel locally and internationally for projects. Travel costs are typically covered by the client and discussed during project planning. I have experience shooting in various locations and can adapt to different environments and requirements.',
      },
      {
        id: 'usage-rights',
        question: 'What usage rights are included?',
        answer: 'Usage rights vary by package. Essential packages include basic commercial use for 6 months, Professional packages include extended rights for 1 year, and Enterprise packages include comprehensive usage rights tailored to your needs. Extended or exclusive rights can be negotiated.',
      },
      {
        id: 'equipment',
        question: 'What equipment do you use?',
        answer: 'I use professional-grade equipment including 4K cameras, professional lighting setups, stabilizers, and high-quality audio equipment. All equipment is regularly updated to ensure the highest quality output and latest technology standards.',
      },
      {
        id: 'revisions',
        question: 'How many revisions are included?',
        answer: 'Revision rounds vary by package: Essential includes 2 rounds, Professional includes unlimited revisions, and Enterprise includes unlimited revisions with priority response times. Additional revisions beyond the included amount can be purchased if needed.',
      },
      {
        id: 'formats',
        question: 'What file formats do you deliver?',
        answer: 'I deliver content in multiple formats optimized for different platforms. This includes high-resolution files for print, web-optimized versions, and social media specific formats (Instagram, TikTok, YouTube, etc.). Custom formats can be provided upon request.',
      },
    ],
  },
  newsletter: {
